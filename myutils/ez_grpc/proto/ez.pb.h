...
#ifndef GOOGLE_PROTOBUF_INCLUDED_ez_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_ez_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_ez_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ez_2eproto;
class Package;
...
class Package final :
 ...
 private:
  ...
  friend struct ::TableStruct_ez_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Package::_internal_version() const {
  return version_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Package::version() const {
  // @@protoc_insertion_point(field_get:Package.version)
  return _internal_version();
}
inline void Package::_internal_set_version(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  version_ = value;
}
inline void Package::set_version(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_version(value);
  // @@protoc_insertion_point(field_set:Package.version)
}

// bytes buffer = 2;
inline void Package::clear_buffer() {
  buffer_.ClearToEmpty();
}
inline const std::string& Package::buffer() const {
  // @@protoc_insertion_point(field_get:Package.buffer)
  return _internal_buffer();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Package::set_buffer(ArgT0&& arg0, ArgT... args) {
 ...
 buffer_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Package.buffer)
}
inline std::string* Package::mutable_buffer() {
  std::string* _s = _internal_mutable_buffer();
  // @@protoc_insertion_point(field_mutable:Package.buffer)
  return _s;
}
inline const std::string& Package::_internal_buffer() const {
  return buffer_.Get();
}
inline void Package::_internal_set_buffer(const std::string& value) {
  
  buffer_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Package::_internal_mutable_buffer() {
  
  return buffer_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Package::release_buffer() {
  // @@protoc_insertion_point(field_release:Package.buffer)
  return buffer_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Package::set_allocated_buffer(std::string* buffer) {
  if (buffer != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Package.buffer)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Package::_internal_length() const {
  return length_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Package::length() const {
  // @@protoc_insertion_point(field_get:Package.length)
  return _internal_length();
}
inline void Package::_internal_set_length(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  length_ = value;
}
inline void Package::set_length(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_length(value);
  // @@protoc_insertion_point(field_set:Package.length)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_ez_2eproto
